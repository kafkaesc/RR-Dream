...
function Attributions() {
	return (
		<ul className="pl-4 mb-4 list-disc">
			<li>
				The image of an arriving train on the home page is from the French movie{' '}
				<em>L'arrivée d'un train en gare de La Ciotat</em> by the Lumière
				brothers. The screenshot is sourced from{' '}
				<A
			...
			<li>
				The view of San Jacinto Plaza in El Paso is provided courtesy of Special
				Collections, University of Houston Libraries and sourced from{' '}
				<A
